import contract from "../../public/asset/images/contract.png";
            ...
            <section className="relative bg-[#0D2436] px-5">
                <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
                    <div className="col-span-12 lg:col-span-6">
                        ...
                        <p className="text-gray-500 text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
                            Get a response tomorrow if you submit by 9pm today.
                            If we received after 9pm will get a reponse the
                            following day.
                        </p>
                    </div>
                            ...
                            <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                                ...
                                <div className="p-5">
                                    ...
                                    <p className="text-dark-light mt-3 text-sm md:text-lg">
                                        Majority of peole will work in jobs that
                                        don’t exist today.
                                    </p>
                                </div>
                            </div>
